...
class EmailUserManager(BaseUserManager):
    def _create_user(self, email, password, phone_number, is_staff, is_superuser, 
    ...
    def create_user(self, email, phone_number, password=None,  **extra_fields):
        return self._create_user(email, password, phone_number, False, False, False,
            **extra_fields)
    
    def create_superuser(self, email, password, phone_number, **extra_fields):
        return self._create_user(email, password, phone_number, True, True, True,
            **extra_fields)
...
class EmailAbstractUser(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.CharField(validators=[phone_regex], max_length=15, blank=True) # validators should be a lis
